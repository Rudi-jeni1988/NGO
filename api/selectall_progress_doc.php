...
try {
    ...
    $query = "SELECT pd.*,trust.uin, trust.mobno, trust.name AS trust_name FROM progress_documents pd INNER JOIN login trust ON pd.trust_id = trust.id WHERE trust_id=$trust_id;";

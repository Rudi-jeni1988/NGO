...
<body class="fund-page">
  ...
  <script>
    $(document).ready(function() {
      ...
      $.ajax({
        url: '../api/fundlist.php', // The API endpoint
        type: 'POST',
        dataType: 'json',
                        ...
                        <ul>
                            <li>
                                ...
                                <p class="float-end text-end">
                                    <a href='javascript:void(0)' class="btn open-btn buy_now" data-amount="${item.amount.toLocaleString()}" data-id='${item.trust_proposal_id }' trust-id='${item.trustid}'>Transfer</a>
                                </p>
  ...
  <script>
    $('body').on('click', '.buy_now', function(e) {
      ...
      var trust_id = $(this).attr("trust-id");
